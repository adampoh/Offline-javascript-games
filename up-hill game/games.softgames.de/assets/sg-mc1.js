    ...
    348: [function(a, b, c) {
        ...
        function l(a, b, c) {
            ...
            try {
                ...
                // debugger;
                g.id = "softgames-loader-css", g.rel = "stylesheet", g.type = "text/css", g.media = "all", g.onload = function() { e() }, g.onerror = function() { e(new Error("Failed to load css")) }, /*g.href = a*/ g.href = "../assets/css/media-controller.css", f.appendChild(g), setTimeout(function() { return e(new Error("Timeout of " + b + "ms reached")) }, b)
            } catch (h) { e(h) }
        }
